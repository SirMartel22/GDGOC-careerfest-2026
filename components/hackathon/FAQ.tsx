  ...
  return (
    <section id="faq" className="py-32 bg-[#F5F5F5]">
      <div className="max-w-4xl mx-auto px-6">
        <div className="flex items-center gap-2 bg-white px-4 py-2 rounded-full border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] w-fit mb-8">
          ...
          {faqs.map((faq, i) => (
            <div key={i} className="border-4 border-black rounded-[2rem] overflow-hidden shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] bg-white transition-all">
              ...
              >
                ...
                <span className={`text-3xl transition-transform duration-300 ${openIndex === i ? 'rotate-180' : ''}`}>👇</span>
              </button>
              {openIndex === i && (
