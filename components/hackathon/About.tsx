...
const About = () => {
  return (
    <section id="about" className="py-32 bg-[#FAAB00] border-y-4 border-black">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-8">
             <div className="flex items-center gap-3 bg-white/20 px-4 py-2 rounded-full border-2 border-black w-fit">
                <Image src="/fav-icon.png" alt="GDG Logo" width={24} height={24} />
                <span className="font-bold text-sm tracking-widest uppercase text-white">// about the challenge</span>
             </div>
